...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Jun-2023 às 23:01
...
ALTER TABLE `favorito`
  ADD PRIMARY KEY (`id_favorito`,`fk_id_filme`,`fk_id_usuario`,`fk_id_perfil`,`fk_id_categoria_filme`,`fk_id_canal_filme`),
  ...
  ADD KEY `fk_favorito_categoria_filme1_idx` (`fk_id_categoria_filme`),
  ADD KEY `fk_favorito_canal_filme1_idx` (`fk_id_canal_filme`);
...
--
ALTER TABLE `favorito`
  ADD CONSTRAINT `fk_favorito_canal_filme1` FOREIGN KEY (`fk_id_canal_filme`) REFERENCES `canal_filme` (`id_canal_filme`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_favorito_categoria__filme1` FOREIGN KEY (`fk_id_categoria_filme`) REFERENCES `categoria_filme` (`id_categoria_filme`) ON DELETE NO ACTION ON UPDATE NO ACTION,
