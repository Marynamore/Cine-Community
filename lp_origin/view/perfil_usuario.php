    ...
    <div class="container">
        <div class="item-details">
            <div class="item-address">
                ...
                <button><a href="../view/alterar_usuario.php?id_usuario=<?= $usuario->getId_usuario() ?>" target="_blank">ALTERAR</a></button>
                <button><a href="../control/excluir.php?id_usuario=<?= $usuario->getId_usuario() ?>">EXCLUIR</a></button>
            </div>
        </div>
    </div>
